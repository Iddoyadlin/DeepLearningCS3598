...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 32, 3, stride=3, padding=1)
        self.relu1 = nn.ReLU()
        ...
        self.conv3 = nn.Conv2d(16, 2, 3, stride=2)
        self.relu3 = nn.ReLU()
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.deconv1 = nn.ConvTranspose2d(2, 64, 3, stride=2)
        self.relu1 = nn.ReLU()

        self.deconv2 = nn.ConvTranspose2d(64, 32, 5, stride=3, padding=1)
        self.relu2 = nn.ReLU()

        self.deconv3 = nn.ConvTranspose2d(32, 16, 2, stride=2, padding=1)
        self.relu3 = nn.ReLU()

        self.deconv4 = nn.ConvTranspose2d(16, 8, 2, stride=2, padding=0)
        self.relu4 = nn.ReLU()

        self.deconv5 = nn.ConvTranspose2d(8, 3, 2, stride=2, padding=0)
        self.tanh = nn.Tanh()
